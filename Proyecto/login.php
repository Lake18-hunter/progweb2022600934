...
// Función para validar credenciales (SIN password_hash)
...
<script>
  ...
  let username = document.getElementById("username").value; // Aquí sigue 'username'
  let clave = document.getElementById("clave").value;
  
  let usernameCorrecta = "1234";  // Correcto, ya que es username
  let claveCorrecta = "password123";

  if (username !== usernameCorrecta) {  // Se mantiene username
    Swal.fire({
      icon: "error",
      title: "Username incorrecto",  // Mantén este mensaje
      text: "Verifica tu username e intenta nuevamente.",
  ...
  setCookie("username", username, 7);  // Guarda el username
